...
class Task(models.Model):
    ...
    due_date = models.DateField(null=True, blank=True, help_text="Enter the task due date.")
    ...
    def __str__(self):
        return f"{self.name} (Completed: {self.completed}), (Priority: {self.priority}), (Due Date: {self.due_date})"